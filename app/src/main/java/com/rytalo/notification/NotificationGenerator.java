...
import controller.ActionButtonNotification;
import controller.BigPictureNotification;
import controller.BigPictureNotificationURL;
import controller.BigTextStyleNotification;
import controller.ChatStyleNotification;
import controller.CustomBigNotification;
import controller.CustomSimpleNotification;
import controller.OpenActivityNotification;
import controller.SimpleNotification;
import controller.TwoIconNotification;
...
*/
    public static void simpleNotification(Context context) {
        ...
        simpleNotification.simpleNotification(context);
    ...
    public static void openActivityNotification(Context context) {
      /*  NotificationCompat.Builder nc = new NotificationCompat.Builder(context);
        ...
        OpenActivityNotification openActivityNotification=new OpenActivityNotification();
        openActivityNotification.openActivityNotification(context);
    }
    ...
    public static void twoIconNotification(Context context) {
      /*  NotificationCompat.Builder nc = new NotificationCompat.Builder(context);
        ...
        TwoIconNotification twoIconNotification=new TwoIconNotification();
        twoIconNotification.twoIconNotification(context);
    }
    ...
    public static void bigPictureNotification(Context context) {
       /* NotificationCompat.Builder nc = new NotificationCompat.Builder(context);
        ...
        BigPictureNotification bigPictureNotification=new BigPictureNotification();
        bigPictureNotification.bigPictureNotification(context);
    }
    ...
    public static void bigTextStyleNotification(Context context) {
       /* NotificationCompat.Builder nc = new NotificationCompat.Builder(context);
        ...
        BigTextStyleNotification bigTextStyleNotification=new BigTextStyleNotification();
        bigTextStyleNotification.bigTextStyleNotification(context);
    }
    ...
    public static void chatStyleNotification(Context context) {
     /*   NotificationCompat.Builder nc = new NotificationCompat.Builder(context);
        ...
        ChatStyleNotification chatStyleNotification=new ChatStyleNotification();
        chatStyleNotification.chatStyleNotification(context);
    }
    ...
    public static void actionButtonNotification(Context context) {
        ...
        ActionButtonNotification actionButtonNotification=new ActionButtonNotification();
        actionButtonNotification.actionButtonNotification(context);
    }
    ...
    public static void customSimpleNotification(Context context) {
        ...
        CustomSimpleNotification customSimpleNotification=new CustomSimpleNotification();
        customSimpleNotification.customSimpleNotification(context);
    }
   ...
   // @SuppressLint("NewApi")
    public static void customBigNotification(Context context) {
      /*  RemoteViews expandedView = new RemoteViews(context.getPackageName(), R.layout.big_notification);
        ...
        CustomBigNotification customBigNotification=new CustomBigNotification();
        customBigNotification.customBigNotification(context);
    }
    public static   void customBigNotificationurl(Context context) {
        BigPictureNotificationURL bigPictureNotificationURL=new BigPictureNotificationURL();
        bigPictureNotificationURL.bigPictureNotification(context);
    }
